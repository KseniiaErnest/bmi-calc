        ...
        <div className="calc-section-text-container">
          <div className="mmm">
            ...
            <p>
              ...
              <br /> our body mass index (BM) calculator. While BMI is not the
              <br /> sole determinant of a healthy weight, it offers a valuable
              <br /> starting point to evaluate your overall health and
              well-being.
            </p>
          </div>
        </div>
